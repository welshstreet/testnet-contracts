...
;; errors
(define-constant ERR_NOT_CONTRACT_OWNER (err u900))
(define-constant ERR_INSUFFICIENT_BALANCE (err u901))
(define-constant ERR_TRANSFER_FAILED (err u902))
(define-constant ERR_COOLDOWN (err u903))
