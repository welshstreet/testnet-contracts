...
describe('=== WELSH FAUCET SET CONTRACT OWNER TESTS ===', () => {
    it('=== WELSH FAUCET SET CONTRACT OWNER PASS ===', () => {
        // STEP 1: Verify initial contract owner is deployer
        getContractOwner(deployer, 'welsh-faucet', deployer, disp);
        
        // STEP 2: Set contract owner to wallet1
        setContractOwner('welsh-faucet', wallet1, deployer, disp);
        getContractOwner(wallet1, 'welsh-faucet', deployer, disp);
    });

    it('=== ERR_NOT_CONTRACT_OWNER - WELSH FAUCET ===', () => {
        // STEP 1: Verify initial contract owner is deployer
        getContractOwner(deployer, 'welsh-faucet', deployer, disp);
        
        // STEP 2: Attempt to set contract owner from unauthorized wallet
        setContractOwner('welsh-faucet', wallet1, wallet2, disp);
